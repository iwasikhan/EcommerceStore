...
<div class="container-wrapper">
    <div class="container">
        ...
        <form:form action="${pageContext.request.contextPath}/admin/product/editProduct" method="post" commandName="product"
            ...
            <form:hidden id="id" path="productId" value="${product.productId}"/>
            ...
            <div class="form-group">
                ...
                <label class="checkbox-inline"><form:radiobutton path="productCategory" id="category" value="clothes" />
                    Clothes</label>

                <label class="checkbox-inline"><form:radiobutton path="productCategory" id="category" value="electronics" />
                    Electronics</label>

                <label class="checkbox-inline"><form:radiobutton path="productCategory" id="category" value="homeappliances" />
